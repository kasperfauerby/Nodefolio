...
.then(( projects ) => {
    ...
    projects.map((project, index) => { 
        ...
        row.insertCell(5).innerHTML = `
            <button id="delete" class="fas-btn" style="height: 25px; width: 50px; background-color: #F70000">
            <i class="fas fa-trash-alt">
            </i></button>
        `
        row.insertCell(6).innerHTML = `
            <button id="update" class="fas-btn" style="height: 25px; width: 50px; background-color: #00F200">
